...
/// 
////////////////////////////////////////////////////////////////////////////////////////////////////
HRESULT	CBandiVideoFileReader::Open(LPCWSTR path_name)
{
	Close();

	HANDLE hFile = CreateFileW(path_name, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_FLAG_SEQUENTIAL_SCAN, NULL);
